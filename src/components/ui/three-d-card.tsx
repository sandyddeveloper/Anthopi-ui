...
export const CardBody = ({ children, className }: { children: React.ReactNode; className?: string }) => {
  return <div className={cn("h-full w-full [transform-style:preserve-3d]", className)}>{children}</div>;
};
...
export const CardItem = ({
  ...
  const isMouseEnter = mouseEnterContext ? mouseEnterContext[0] : false;
